...
export const CORE_SERVICES: ServiceDoc[] = [
  {
    id: 'inject-platform',
    name: 'injectPlatform',
    description: `[v21 Legacy] Composable that resolves the current platform environment using Angular's Dependency Injection. Returns a typed object with \`isBrowser\`, \`isServer\`, \`window\`, and \`document\` fields. Gracefully falls back when called outside an injection context (e.g. unit tests).`,
    scope: 'provided',
