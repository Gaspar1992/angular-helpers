...
export const BROWSER_WEB_APIS_SERVICES: ServiceDoc[] = [
  {
    id: 'battery',
    name: 'BatteryService',
    description: 'Provides access to the Battery Status API, allowing you to monitor device battery level, charging state, and receive reactive updates via Observables.',
    scope: 'provided',
...
export class BatteryComponent {
  ...
  async ngOnInit() {
    ...
    fnVersion: {
      ...
      description: 'Provides reactive battery status via signals. Automatically initializes and watches battery changes with cleanup on destroy.',
      fields: [
        {
          name: 'info',
...
export class BatteryComponent {
  ...
  },
  {
    ...
    description: 'Detects browser capabilities and feature support. Allows you to check whether specific browser APIs are available before using them.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'All modern browsers',
    notes: [
      'Use this service to guard API usage before instantiating other services.'
    ],
    category: 'security',
    methods: [
      {
      ...
      },
      {
        ...
        signature: 'getPermissionState(permission: PermissionName): Promise<PermissionState | \'unknown\'>',
...
export class MyComponent {
  ...
  },
  {
    id: 'camera',
    name: 'CameraService',
    description: 'Manages camera access via the MediaDevices API. Handles permission checks, stream lifecycle, and photo capture with typed constraints.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    ...
    methods: [
      ...
      {
        name: 'switchCamera',
        signature: 'switchCamera(deviceId: string, constraints: MediaStreamConstraints): Promise<MediaStream>',
        description: 'Public method switchCamera.',
        returns: 'Promise<MediaStream>'
      },
      {
        name: 'getCameraCapabilities',
        signature: 'getCameraCapabilities(deviceId: string): Promise<MediaTrackCapabilities | null>',
    ...
    guides: [
      {
        ...
        description: 'This guide details how to build a robust photo capture interface with reactive camera permission checks, dynamic constraint adjustments, and automatic MediaStream resource cleanup when the host component is destroyed.',
        files: [
          {
...
export class AvatarCaptureComponent implements OnInit, OnDestroy {
  ...
  },
  {
    ...
    description: 'Provides a type-safe wrapper around the Clipboard API for reading from and writing to the system clipboard, with automatic permission verification.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✓ · Safari ✓ · Edge ✓',
...
export class ClipboardComponent {
  ...
  async paste() {
    ...
    fnVersion: {
      ...
      description: 'Provides reactive clipboard access via signals. Tracks text content, errors, busy state, and API support without manual subscription management.',
      fields: [
        {
          name: 'text',
          type: 'Signal<string | null>',
...
export class CopyButtonComponent {
  ...
  },
  {
    ...
    description: 'Wraps the Geolocation API with typed Promises and Observables. Supports one-time position queries and continuous position watching with automatic cleanup.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✓ · Safari ✓ · Edge ✓',
...
export class MapComponent {
  ...
  startTracking() {
    ...
    fnVersion: {
      ...
      description: 'Provides reactive geolocation via signals. Tracks position, errors, and watch state with automatic cleanup on component destroy.',
      fields: [
        {
          name: 'position',
...
export class MapComponent {
  ...
  },
  {
    ...
    description: 'Enumerates and manages media input/output devices (cameras, microphones, speakers). Provides reactive device change detection.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✓ · Safari ✓ · Edge ✓',
...
export class DeviceSelectorComponent {
  ...
  },
  {
    ...
    description: 'Manages browser push notifications — requesting permissions and displaying notifications with typed options.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: true,
...
export class AlertComponent {
  ...
  },
  {
    ...
    description: 'Centralizes browser permission queries. Used internally by other services and directly available for custom permission checks.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'Chrome ✓ · Firefox ✓ · Safari partial · Edge ✓',
    notes: [
      'Some permissions are not queryable in all browsers (e.g. clipboard in Firefox).'
    ],
    category: 'security',
    methods: [
      {
...
export class PermissionCheckComponent {
  ...
  },
  {
    ...
    description: 'Wraps the Web Share API to trigger the native device share sheet. Supports sharing URLs, text, and files.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox partial · Safari ✓ · Edge ✓ (mobile focused)',
    notes: [
      'Requires a user gesture to trigger.',
      'File sharing support varies by browser.'
    ],
    category: 'system',
    methods: [
      {
...
export class ShareButtonComponent {
  ...
  },
  {
    ...
    description: 'Manages WebSocket connections with automatic reconnection, heartbeat support, and typed message streams via Observables.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'All modern browsers',
...
export class ChatComponent {
  ...
  },
  {
    ...
    description: 'Type-safe wrapper for localStorage and sessionStorage with JSON serialization, optional key prefixing, and reactive change detection via Observables.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'All modern browsers',
    ...
    methods: [
      ...
      },
      {
        ...
        signature: 'getLocalStorage(key: string, defaultValue: T | null, options: StorageOptions): T | null',
      ...
      },
      {
        ...
        signature: 'getSessionStorage(key: string, defaultValue: T | null, options: StorageOptions): T | null',
      ...
      },
      {
        ...
        signature: 'watchSessionStorage(key: string, options: StorageOptions): Observable<T | null>',
...
export class PreferencesComponent {
  ...
  },
  {
    ...
    description: 'Manages Web Worker lifecycle — creation, typed message passing, status tracking, and cleanup — with an Observable-based API.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'All modern browsers',
...
accessible later via .`,
      ...
      {
        name: 'request',
        signature: 'request(workerName: string, type: string, data: TReq, opts?: WorkerRequestOptions): Promise<TRes>',
...
\`\`\``,
      ...
      {
        name: 'getMessagesByType',
        signature: 'getMessagesByType(workerName: string, type: string): Observable<WorkerMessage<T>>',
        description: 'Public method getMessagesByType.',
        returns: 'Observable<WorkerMessage<T>>'
      },
      {
...
export class ProcessingComponent {
  ...
  },
  {
    ...
    description: 'Wraps the IntersectionObserver API with an Observable-based interface. Detects when elements enter or leave the viewport with configurable thresholds and root margins.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'All modern browsers',
    ...
    methods: [
      {
        name: 'observe',
        signature: 'observe(element: Element, options: IntersectionObserverOptions): Observable<IntersectionObserverEntry[]>',
        description: 'Public method observe.',
        returns: 'Observable<IntersectionObserverEntry[]>'
      },
      {
        name: 'observeVisibility',
        signature: 'observeVisibility(element: Element, options: IntersectionObserverOptions): Observable<boolean>',
...
export class LazyImageComponent {
  ...
  ngAfterViewInit() {
    ...
    fnVersion: {
      ...
      description: 'Observes when an element enters or leaves the viewport. Returns reactive signals updated automatically — no subscriptions, no teardown code needed.',
      fields: [
        {
          name: 'isIntersecting',
          type: 'Signal<boolean>',
...
export class LazyCardComponent {
  ...
  },
  {
    ...
    description: 'Wraps the ResizeObserver API. Emits element size information whenever the observed element changes dimensions.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'All modern browsers',
    notes: [
      'Automatically disconnects on component destroy.'
    ],
    category: 'observer',
    methods: [
      {
        name: 'observe',
        signature: 'observe(element: Element, options: ResizeObserverOptions): Observable<ResizeObserverEntry[]>',
        description: 'Public method observe.',
        returns: 'Observable<ResizeObserverEntry[]>'
      },
      {
        name: 'observeSize',
        signature: 'observeSize(element: Element, options: ResizeObserverOptions): Observable<ElementSize>',
...
export class ResponsiveComponent {
  ...
  ngAfterViewInit() {
    ...
    fnVersion: {
      ...
      description: 'Reactively tracks an element\'s dimensions. Returns signals for width, height, and box sizes that update on every resize — no subscriptions or cleanup needed.',
      fields: [
        {
          name: 'width',
          type: 'Signal<number>',
...
export class ResponsiveComponent {
  ...
  },
  {
    ...
    description: 'Tracks document visibility state using the Page Visibility API. Useful for pausing background tasks when the tab is hidden.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'All modern browsers',
...
export class VideoComponent {
  ...
  ngOnInit() {
    ...
    fnVersion: {
      ...
      description: 'Tracks document visibility as reactive signals. Initialises immediately from document.visibilityState and updates whenever the user switches tabs.',
      fields: [
        {
          name: 'state',
...
export class VideoComponent {
  ...
  },
  {
    ...
    description: 'Provides Observable-based inter-tab and inter-context communication via the BroadcastChannel API. Channels are auto-closed on component destroy.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'Chrome ✓ · Firefox ✓ · Safari ✓ · Edge ✓',
...
export class SyncComponent {
  ...
  },
  {
    ...
    description: 'Provides access to the Network Information API. Reports online status, connection type, effective type, downlink speed, and round-trip time.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
...
export class OfflineBannerComponent {
  ...
  ngOnInit() {
    ...
    fnVersion: {
      ...
      description: 'Provides network state as reactive signals. Updates automatically on online/offline events and connection changes without any subscription management.',
      fields: [
        {
          name: 'online',
          type: 'Signal<boolean>',
...
export class OfflineBannerComponent {
  ...
  },
  {
    ...
    description: 'Prevents the device screen from dimming or locking via the Screen Wake Lock API. Automatically re-acquires the lock when the tab becomes visible again.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: true,
...
export class PresentationComponent {
  ...
  async releaseScreen() {
    ...
    fnVersion: {
      ...
      description: 'Provides reactive screen wake lock control via signals. Tracks active state, errors, and API support with automatic cleanup on component destroy.',
      fields: [
        {
          name: 'active',
          type: 'Signal<boolean>',
...
export class PresentationComponent {
  ...
  },
  {
    ...
    description: 'Reads and watches the screen orientation type and angle. Supports programmatic orientation locking for mobile applications.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'Chrome ✓ · Firefox ✓ · Safari partial · Edge ✓',
...
export class MobileComponent {
  ...
  async lockLandscape() {
    ...
    fnVersion: {
      ...
      description: 'Exposes screen orientation as reactive signals. Includes lock/unlock methods for programmatic orientation control on mobile devices.',
      fields: [
        {
          name: 'type',
...
export class MobileComponent {
  ...
  },
  {
    ...
    description: 'Manages fullscreen mode for any DOM element. Supports entering, exiting, and toggling fullscreen with webkit prefix fallback.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'All modern browsers',
    ...
    methods: [
      {
        name: 'isSupported',
        signature: 'isSupported(): boolean',
        description: 'Override to also check the *enabled* flag (browser may have disabled fullscreen).',
        returns: 'boolean'
      },
      {
        name: 'request',
...
export class VideoPlayerComponent {
  ...
  },
  {
    ...
    description: 'Provides access to the File System Access API for opening and saving files via the native OS picker. Supports single/multiple file selection, save dialogs, and directory access.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✗ · Safari ✗ · Edge ✓',
...
export class FileEditorComponent {
  ...
  },
  {
    ...
    description: 'Wraps the MediaRecorder API for recording audio and video from a MediaStream. Provides start, pause, resume, and stop controls with Observable state and data streams.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: true,
...
export class RecorderComponent {
  ...
  },
  {
    ...
    description: 'Manages Server-Sent Events (SSE) connections. Supports typed message streams, custom event types, and multiple concurrent connections identified by URL.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'All modern browsers',
...
export class LiveFeedComponent {
  ...
  },
  {
    ...
    description: 'Triggers haptic feedback patterns via the Vibration API. Includes built-in presets for common interactions (success, error, notification, double-tap).',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
...
export class FeedbackComponent {
  ...
  },
  {
    ...
    description: 'Text-to-speech via the Web Speech Synthesis API. Supports voice selection, language, pitch, rate, and volume. Exposes speaking state as an Observable.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'Chrome ✓ · Firefox ✓ · Safari ✓ · Edge ✓',
...
export class VoiceComponent {
  ...
  },
  {
    ...
    description: 'Wraps the MutationObserver API with an Observable-based interface. Detects DOM mutations such as child additions, attribute changes, and text content modifications.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'All modern browsers',
    ...
    methods: [
      {
        name: 'observe',
        signature: 'observe(target: Node, options?: MutationObserverOptions): Observable<MutationRecord[]>',
        description: 'Public method observe.',
...
export class DomWatcherComponent {
  ...
  ngAfterViewInit() {
    ...
    fnVersion: {
      ...
      description: 'Reactively tracks DOM mutations on an element. Returns signals updated automatically on each mutation batch — no subscriptions or teardown needed.',
      fields: [
        {
          name: 'mutations',
...
export class DomWatcherComponent {
  ...
  },
  {
    ...
    description: 'Wraps the PerformanceObserver API for monitoring performance entries such as LCP, FID, CLS, navigation timing, and resource loading metrics.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'All modern browsers',
    ...
    methods: [
      ...
      {
        name: 'observeByType',
        signature: 'observeByType(type: PerformanceEntryType, buffered: any): Observable<PerformanceEntryList>',
...
export class MetricsComponent {
  ...
  ngOnInit() {
    ...
    fnVersion: {
      ...
      description: 'Tracks performance entries as reactive signals. Automatically updates when new entries are observed.',
      fields: [
        {
          name: 'entries',
...
export class MetricsComponent {
  ...
  },
  {
    ...
    description: 'Detects user idle state and screen lock status using the Idle Detection API. Useful for auto-logout, presence indicators, or pausing resource-intensive tasks.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✗ · Safari ✗ · Edge ✓',
...
export class PresenceComponent {
  ...
  async start() {
    ...
    fnVersion: {
      ...
      description: 'Exposes user idle and screen lock state as reactive signals. Automatically starts monitoring and cleans up on destroy.',
      fields: [
        {
          name: 'userState',
...
export class PresenceComponent {
  ...
  },
  {
    ...
    apiName: 'EyeDropper',
    description: 'Provides access to the EyeDropper API for picking colors from anywhere on the screen. Opens a system color picker that returns the selected color in sRGB hex format.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✗ · Safari ✗ · Edge ✓',
...
export class ColorPickerComponent {
  ...
  },
  {
    ...
    description: 'Wraps the Barcode Detection API (Shape Detection API) for scanning barcodes and QR codes from images, video frames, or canvas elements.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis/experimental',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✗ · Safari ✗ · Edge ✓',
    ...
    methods: [
      ...
      {
        name: 'detect',
        signature: 'detect(source: ImageBitmapSource, formats?: BarcodeFormat[]): Promise<DetectedBarcode[]>',
        description: 'Public method detect.',
        returns: 'Promise<DetectedBarcode[]>'
      },
      {
        name: 'detectStream',
        signature: 'detectStream(video: HTMLVideoElement, options: { formats?: BarcodeFormat[]; interval?: number }): Observable<DetectedBarcode[]>',
...
export class ScannerComponent {
  ...
  },
  {
    ...
    apiName: 'Web Audio',
    description: 'Manages Web Audio API contexts, nodes, and audio processing. Supports oscillators, gain control, analysers for visualization, audio decoding, and playback.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'All modern browsers',
    ...
    methods: [
      ...
      {
        name: 'watchAnalyser',
        signature: 'watchAnalyser(analyser: AnalyserNode, intervalMs: any): Observable<AudioAnalyserData>',
...
export class ToneComponent {
  ...
  },
  {
    ...
    name: 'GamepadService',
    apiName: 'Gamepad',
    description: 'Provides access to the Gamepad API for reading game controller input. Supports connection events, polling for button/axis state, and listing connected gamepads.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✓ · Safari ✓ · Edge ✓',
    ...
    methods: [
      ...
      },
      {
        ...
        signature: 'watchConnections(): Observable<{ gamepad: GamepadState; type: \'connected\' | \'disconnected\' }>',
...
export class GameInputComponent {
  ...
  startPolling() {
    ...
    fnVersion: {
      ...
      description: 'Polls a gamepad and exposes its state as reactive signals. Automatically starts polling and cleans up on destroy.',
      fields: [
        {
          name: 'state',
...
export class GameInputComponent {
  ...
  },
  {
    ...
    description: 'Provides access to the Web Bluetooth API for connecting to Bluetooth Low Energy (BLE) devices. Supports device discovery, GATT service/characteristic read/write, and notifications.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis/experimental',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✗ · Safari ✗ · Edge ✓',
    ...
    methods: [
      {
        name: 'requestDevice',
        signature: 'requestDevice(options?: BluetoothRequestDeviceOptions): Promise<BluetoothDeviceRef>',
      ...
      },
      {
        ...
        signature: 'writeCharacteristic(server, serviceUuid, characteristicUuid, value): Promise<void>',
        description: 'Writes a value to a BLE characteristic.',
        returns: 'Promise<void>'
      },
      {
        name: 'watchCharacteristic',
        signature: 'watchCharacteristic(server, serviceUuid, characteristicUuid): Observable<DataView>',
...
export class BleComponent {
  ...
  },
  {
    ...
    name: 'WebUsbService',
    apiName: 'WebUSB',
    description: 'Provides access to the WebUSB API for communicating with USB devices from the browser. Supports device discovery, configuration, interface claiming, and data transfer.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis/experimental',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✗ · Safari ✗ · Edge ✓',
    ...
    methods: [
      ...
      {
        name: 'transferIn',
        signature: 'transferIn(device: UsbDeviceRef, endpointNumber: number, length: number): Promise<UsbTransferResult>',
        description: 'Reads data from a USB endpoint.',
        returns: 'Promise<UsbTransferResult>'
      },
      {
        name: 'transferOut',
        signature: 'transferOut(device: UsbDeviceRef, endpointNumber: number, data: BufferSource): Promise<UsbTransferResult>',
        description: 'Writes data to a USB endpoint.',
        returns: 'Promise<UsbTransferResult>'
      },
      {
        name: 'watchConnection',
        signature: 'watchConnection(): Observable<{ device: UsbDeviceRef; type: \'connect\' | \'disconnect\' }>',
...
export class UsbComponent {
  ...
  },
  {
    ...
    name: 'WebNfcService',
    apiName: 'Web NFC',
    description: 'Provides access to the Web NFC API for reading and writing NFC tags. Supports NDEF message scanning and writing.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis/experimental',
    requiresSecureContext: true,
    ...
    methods: [
      ...
      {
        name: 'write',
        signature: 'write(message: NdefMessage | string, options?: NdefWriteOptions): Promise<void>',
...
export class NfcComponent {
  ...
  },
  {
    ...
    description: 'Wraps the Payment Request API for initiating native payment flows. Supports payment method validation, payment sheet display, and result handling.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis/experimental',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✓ · Safari ✓ · Edge ✓',
    ...
    methods: [
      {
        name: 'canMakePayment',
        signature: 'canMakePayment(methods: PaymentMethodConfig[], details: PaymentDetailsInit): Promise<boolean>',
        description: 'Checks whether the user can make a payment with the given methods.',
        returns: 'Promise<boolean>'
      },
      {
        name: 'show',
        signature: 'show(methods: PaymentMethodConfig[], details: PaymentDetailsInit, options?: PaymentOptionsConfig): Promise<PaymentResult>',
...
export class CheckoutComponent {
  ...
  },
  {
    ...
    description: 'Wraps the Credential Management API for managing user credentials. Supports password credentials, public key credentials (WebAuthn/passkeys), and silent sign-in prevention.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis/experimental',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✓ · Safari partial · Edge ✓',
    ...
    methods: [
      ...
      },
      {
        ...
        signature: 'createPublicKeyCredential(options: PublicKeyCredentialOptions): Promise<Credential | null>',
...
export class LoginComponent {
  ...
  },
  {
    ...
    apiName: 'Web Locks',
    description: 'Coordinates exclusive or shared access to a named resource across tabs and workers using the Web Locks API. Useful for preventing concurrent operations on shared resources.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✓ · Safari ✓ · Edge ✓',
    ...
    methods: [
      ...
      {
        name: 'acquire',
        signature: 'acquire(name: string, callback: () => Promise<T> | T, options: LockOptionsLike): Promise<T>',
...
export class SyncComponent {
  ...
  },
  {
    ...
    description: 'Provides access to the Storage Manager API for checking storage quotas and requesting persistent storage that is protected from automatic eviction.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: true,
    browserSupport: 'Chrome ✓ · Firefox ✓ · Safari ✓ · Edge ✓',
...
export class StorageComponent {
  ...
  },
  {
    ...
    description: 'Wraps the Compression Streams API for gzip/deflate compression and decompression of Uint8Array data. Useful for reducing transfer sizes or storing compressed data locally.',
    scope: 'provided',
    importPath: '@angular-helpers/browser-web-apis',
    requiresSecureContext: false,
    browserSupport: 'Chrome ✓ · Firefox ✓ · Safari ✗ · Edge ✓',
    ...
    methods: [
      ...
      {
        name: 'compress',
        signature: 'compress(data: Uint8Array | ArrayBuffer, format: CompressionFormat): Promise<Uint8Array>',
        description: `Compress a \`Uint8Array\`/\`ArrayBuffer\` using the given format.`,
        returns: 'Promise<Uint8Array>'
      },
      {
        name: 'decompress',
        signature: 'decompress(data: Uint8Array | ArrayBuffer, format: CompressionFormat): Promise<Uint8Array>',
      ...
      },
      {
        ...
        signature: 'decompressString(data: Uint8Array | ArrayBuffer, format: CompressionFormat): Promise<string>',
